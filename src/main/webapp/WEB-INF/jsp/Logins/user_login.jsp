...
<head>
 ...
 <%@include file="/WEB-INF/jsp/include-js.jsp" %>
    ...
    <%@include file="/WEB-INF/jsp/navbars/user_login_navbar.jsp" %>
	  <div class="container">
	    <div class="forma">
	      <div >
	        <div class="card">
	          <div class="card-body " >
				<form name='loginForm' action="${pageContext.request.contextPath}/UserIndex" method='GET' id="login-form" autocomplete="off" >
	            ...
	            <div class="options">
                    <a href="${pageContext.request.contextPath}/UserRegister"class="option2" id="to-register" ></i>Aún no tienes cuenta? Registrate aquí!</a> 
	            </div>
	            <div class="options">
