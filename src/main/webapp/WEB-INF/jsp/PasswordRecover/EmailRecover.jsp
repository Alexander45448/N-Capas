	  ...
	  <div class="container">
	    <div class="forma">
	      <div >
	        <div class="card">
	          <div class="card-body " >
				<form name='EmailForm' action="${pageContext.request.contextPath}/PasswordRecover" method='GET' id="email-form" autocomplete="off" >
	            <div class="form-outline mb-3">
	              <label class="label-email" for="email">Digite su correo Electronico:</label>	
	              <input class="form-control col-12 col-m-6 col-lg-10 " type="text"   required="" name="email" autocomplete="off">
	            </div>
	          </div>
	        </div>
	     	  <button class="btn-submit" type="submit">Recuperar Contraseña</button>  
	     	</form>  
	      </div>
	    </div>
	  </div>
