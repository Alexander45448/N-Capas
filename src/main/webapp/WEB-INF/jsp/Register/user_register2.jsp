	    ...
	    <div class="forma">
	      <div >
	        ...
	        <label class="registerLabel" for="registerLabel">SALUDPLUS</label>	
	          <div class="card-body " >
				<form name='loginForm' action="${pageContext.request.contextPath}/user_login" method='GET' id="login-form" autocomplete="off" >
				<table class="tabla">
				  <tr>
				    <td style="width:40%;">Nombre Completo:</td>
				    <td style="width:60%;">
						<div class="form-outline mb-3">
		                	<input class="form-control col-12 col-m-6 col-lg-13 " type="text" required="" placeholder="Ingrese su nombre completo" name="user_name" autocomplete="off">
		            	</div>
					</td>
				  </tr>
				  <tr>
	            ...
	            <div class="form-outline mb-3">
					<nav aria-label="...">
					  <ul class="pagination justify-content-center">
					    <li class="page-item ">
					      <a class="page-link" href="${pageContext.request.contextPath}/UserRegister" tabindex="-1">Previous</a>
					    </li>
					    <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/UserRegister">1</a></li>
